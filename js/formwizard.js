...
formtowizard.prototype={
	...
	init:function(setting){
		...
		jQuery(function($){ //on document.ready
			...
			var $paginatediv=$('<div class="formpaginate" style="overflow:hidden;"><span class="prev" style="float:left"><i class="icon-arrow-left"></i> &nbsp;&nbsp; Back</span> <span class="status">Step 1 of </span> <span class="next" style="float:right">Next &nbsp;&nbsp; <i class="icon-arrow-right"></i></span></div>')
